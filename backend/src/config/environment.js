...
const env = {
  ...
  REDIS_ACTIVATION_TOKEN_DURATION: process.env.REDIS_ACTIVATION_TOKEN_DURATION,
  REDIS_EMAIL_RESEND_LIMIT: process.env.REDIS_EMAIL_RESEND_LIMIT,
  REDIS_EMAIL_RESEND_WINDOW: process.env.REDIS_EMAIL_RESEND_WINDOW,
